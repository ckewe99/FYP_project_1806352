            ...
            <div class="row">
                ...
                <div class="col-md-8 form-group {{ $errors->has('email') ? 'has-danger' : '' }}">
                    <input type="text" name="email" class="form-control @error('email') is-invalid @enderror"
                        placeholder="{{ __('Please Enter email') }}" value="{{ old('email') }}" autofocus required>
                    @error('email')
            ...
            <div class="row">
                ...
                <div class="col-md-8 form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                        placeholder="{{ __('Please Enter Name') }}" value="{{ old('name') }}" autofocus required>
                    @error('name')
                        <div class="invalid-div text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 form-group {{ $errors->has('student_physical_id') ? 'has-danger' : '' }}">
                    <input type="text" name="student_physical_id"
                        ...
                        placeholder="{{ __('Please Enter Student ID') }}" value="{{ old('student_physical_id') }}"
                        autofocus>
            ...
            <div class="row">
                ...
                <div class="col-md-8 form-group {{ $errors->has('password') ? 'has-danger' : '' }}">
                    <input type="password" name="password" class="form-control @error('password') is-invalid @enderror"
                        placeholder="{{ __('Please Enter Password') }}" value="{{ old('password') }}" autofocus required>
                    @error('password')
                        <div class="invalid-div text-danger">{{ $message }}</div>
                    @enderror
                </div>
